...
namespace Laboratorio.Api
{
    ...
    [ApiController]
    public class Pacientes1Controller : ControllerBase
    {
        private readonly DataContext _context;

        public Pacientes1Controller(DataContext context)
        {
            _context = context;
        }
